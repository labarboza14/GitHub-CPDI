...
-- -- Criação das variáveis para armazenamento dos parametros de frequencia e dampingRadio
-- local springFrequency = 30
-- local springDampingRatio = 1.0

-- -- Criação da junta ja dentro da string joints ([#joints+1]) faz com que a variável seja sobrescrita
-- joints[#joints+1] = physics.newJoint ("wheel", vehicleBody, wheelA, wheelA.x, wheelA.y, 1, 1)
-- --Atribui a frequencia e damping a junta dos valores criados
...
-- --Aplicação do toruqe as rodas para a movimentação das rodas
...
-- Criando a junta de polia ("tipo de junta", corpoA, corpoB, ancora do corpoA, corpoB, pinoA.x, pinoA.y, pinoB.x, pinoB.y, ancoraA.x, ancoraA.y, ancoraB.x, ancoraB.y
